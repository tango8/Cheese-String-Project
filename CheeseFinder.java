...
public class CheeseFinder {
    ...
    public static void main(String[] args)
    {
        ...
        boolean printDatabasesTrue = yesNoPrintDatabases();
    ...
    private static boolean yesNoPrintDatabases() {
        System.out.println("Do you want to print out the URLs being searched through each output? y/n");
        String yesNoPrint = scanner.nextLine().toLowerCase().trim();

        if (yesNoPrint.equals("y") || yesNoPrint.equals("yes")) {
            return true;
        }
        return false;
    }
